...
class RPNCalculator implements RPN
{
    private array $operators = ['+', '-', '*', '/'];

    /**
     *  Calculate the result of the given expression in Reverse Polish Notation (RPNCalculator).
     *
     * @param string $input The expression in RPNCalculator
